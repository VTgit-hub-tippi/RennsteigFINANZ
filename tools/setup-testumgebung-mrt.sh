...
ROLLBACK_TEMPLATE_SRC="$ROOT_DIR/docs/ROLLBACK-NACHWEIS-VORLAGE.txt"
ROLLBACK_CSV_TEMPLATE_SRC="$ROOT_DIR/docs/ROLLBACK-NACHWEIS-VORLAGE.csv"
...
ROLLBACK_TEMPLATE_DST="$TEST_DIR/ROLLBACK-NACHWEIS-VORLAGE.txt"
ROLLBACK_CSV_TEMPLATE_DST="$TEST_DIR/ROLLBACK-NACHWEIS-VORLAGE.csv"
...
need_readable_file "$ROLLBACK_TEMPLATE_SRC"
need_readable_file "$ROLLBACK_CSV_TEMPLATE_SRC"
...
cp -f "$ROLLBACK_TEMPLATE_SRC" "$ROLLBACK_TEMPLATE_DST"
cp -f "$ROLLBACK_CSV_TEMPLATE_SRC" "$ROLLBACK_CSV_TEMPLATE_DST"
